          ...
          <div className="flex justify-center">
            ...
            <div className="flex flex-col w-full max-w-lg">
              <SheetHeader>
                ...
                <SheetDescription>
                  Enter their <Link href="https://www.base.org/" target="_blank"
                    className="text-blue-500 hover:underline">Base</Link> account address or ENS name
                </SheetDescription>
              </SheetHeader>
              <div className="py-4 pb-20 flex flex-col gap-2">
