...
export default function Page() {
	...
	return (
		<div
			className="flex flex-col gap-20 w-full items-center backdrop-blur-[3px]"
		...
		>
			...
			<div className="flex flex-col md:min-h-[500px] md:flex-row md:gap-14 w-full items-center space-y-6">
				...
				<div className="md:w-1/2">
					<Image
						src="/laptop-n-phone-based-chess-screenshot.png"
				...
				{games.map((game) => (
					<div key={game.gameId} className="p-4 max-w-lg">
						<div className="border border-gray-300 rounded-lg p-4 gap-2">
							<a href={`/games/${game.gameId}`} className="text-lg font-semibold">
								Go to Game
							</a>
